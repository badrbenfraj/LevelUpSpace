                        ...
                        <div className="row">
                            ...
                            <div className="col-4">
                                ...
                                <ul className="navbar-nav contactAdress">
                                    <li className="nav-item"><i className="fas fa-map-marker-alt"></i>Jl. Haji Muhidin, Blok G no.69</li>
                                    <li className="nav-item"><i className="fas fa-phone"></i>025-2839341</li>
                                    <li className="nav-item"><i className="far fa-envelope"></i>solo@gretong.com</li>
                                </ul>
                            </div>
                        </div>
                    </div>
