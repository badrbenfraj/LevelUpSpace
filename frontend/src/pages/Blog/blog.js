										...
										return (
											<article className="type-post" key={blog._id}>
												<div className="entry-cover">
													<Link title="Cover" to="blogpost-page.html"><img width="800" height="470" alt="latestnews" src="img/blog1.jpg" /></Link>
												</div>
												<div className="entry-block">
													<div className="entry-contentblock">
														...
														<Link to="blogpost-page.html" title="Read More">Read More</Link>
													</div>
										...
										<div className="col-md-3 col-sm-4 widget-area">
											...
											<aside className="widget widget_latestnews">
												...
												<div className="latestnews-box">
													<Link to="blogpost-page.html" title="Along Communicate Directly With Experienced Teachers">{blog.createdDate}</Link>
													<span>20th April 2019</span>
												</div>
												<div className="latestnews-box">
													<Link to="blogpost-page.html" title="Given The Tips To Students Succed In An Online Courses ">{blog.createdDate}</Link>
													<span>20th April 2019</span>
												</div>
												<div className="latestnews-box">
													<Link to="blogpost-page.html" title="Why Should Read Every Day">{blog.createdDate}</Link>
													<span>20th April 2019</span>
												</div>
											</aside>
